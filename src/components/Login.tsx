...
import { Lock, User as UserIcon, ShieldCheck, Zap, Smartphone, Globe, ArrowRight, LayoutDashboard, Sparkles, MessageSquare, Building2, ChevronDown } from 'lucide-react';
...
export function Login() {
  ...
  return (
    // CAMBIO CLAVE: flex-col-reverse pone el lado derecho (Login) arriba en móviles, y el izquierdo (Info) abajo.
    <div className="min-h-screen flex flex-col-reverse lg:flex-row bg-slate-50 font-sans selection:bg-blue-500/30 overflow-x-hidden">
      ...
      {/* --- LADO IZQUIERDO: PRESENTACIÓN CORPORATIVA (Ahora visible al hacer scroll en móvil) --- */}
      <div className="w-full lg:w-[50%] xl:w-[55%] bg-slate-950 text-white p-8 sm:p-12 flex flex-col justify-between relative min-h-screen lg:min-h-0 z-10">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center py-10 lg:py-0">
          <div className="flex items-center gap-3 mb-10 lg:mb-16">
            <div className="w-10 h-10 lg:w-12 lg:h-12 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-600/20 shrink-0">
              <LayoutDashboard className="w-6 h-6 lg:w-7 lg:h-7 text-white" />
            </div>
            <span className="text-xl lg:text-2xl font-black tracking-tight uppercase">CataSystem</span>
          </div>
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between border-t border-white/10 pt-8 mt-12 gap-6 sm:gap-0">
          <div>
            ...
            <p className="text-sm lg:text-base font-black text-slate-300 tracking-wide flex items-center gap-2">VASR LINK</p>
          </div>
          <div className="sm:text-right">
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">Ingeniería</p>
            <p className="text-sm lg:text-base font-black text-slate-300 tracking-wide">Ing. Emilio Frey</p>
          </div>
        </div>
      </div>

      {/* --- LADO DERECHO: INTERFAZ DE LOGIN (Arriba en móviles) --- */}
      <div className="w-full lg:w-[50%] xl:w-[45%] flex flex-col relative bg-slate-50/80 min-h-screen lg:min-h-0">
        ...
        {/* NAVEGACIÓN SUPERIOR (Botones Más Grandes y Visibles) */}
        <nav className="relative z-20 w-full p-4 sm:p-6 flex flex-wrap justify-center lg:justify-end items-center gap-x-6 gap-y-4 border-b border-black/5 lg:border-none bg-white/50 lg:bg-transparent backdrop-blur-md">
          <div className="flex gap-6 items-center">
            <button type="button" className="text-sm font-bold text-slate-600 hover:text-slate-900 transition-colors flex items-center gap-1.5 py-2">
              <Building2 className="w-4 h-4 sm:w-5 sm:h-5" /> Quiénes Somos
            </button>
            <button type="button" className="text-sm font-bold text-slate-600 hover:text-slate-900 transition-colors flex items-center gap-1.5 py-2">
              <MessageSquare className="w-4 h-4 sm:w-5 sm:h-5" /> Contacto
            </button>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative z-10">
          <div className="w-full max-w-[400px]">
            ...
            <div className="lg:hidden flex items-center gap-3 mb-10 justify-center">
              ...
              <span className="text-3xl font-black tracking-tight uppercase text-slate-900">CataSystem</span>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-[2.5rem] p-8 sm:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-white relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full bg-white/50 border border-slate-200 text-slate-900 rounded-2xl pl-12 pr-4 py-4 text-sm font-semibold outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm focus:bg-white"
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-slate-900 text-white rounded-2xl py-4 text-sm sm:text-base font-bold mt-6 hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-500/30 transition-all flex items-center justify-center gap-2 group active:scale-95"
                >
                  Entrar al Sistema
        ...
        {/* --- INDICADOR DE SCROLL (Solo en móviles) --- */}
        <div className="lg:hidden flex flex-col items-center justify-center pb-8 text-slate-400 animate-bounce">
          <span className="text-[10px] uppercase font-bold tracking-widest mb-1">Descubre más</span>
